 ...
 */
@FunctionalInterface
public interface Executable8Throwing8<X1, X2, X3, X4, X5, X6, X7, X8, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {

    /**
     * Execute the action logic by the specified 8 input arguments.
     *
     ...
     */
    void exec(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5, X6 x6, X7 x7, X8 x8) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     */
    default Executable8Throwing8<X1, X2, X3, X4, X5, X6, X7, X8, E1, E2, E3, E4, E5, E6, E7, E8> then(Executable8Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? super X6, ? super X7, ? super X8, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> after) {
        return ((Executable8Throwing8<X1, X2, X3, X4, X5, X6, X7, X8, E1, E2, E3, E4, E5, E6, E7, E8>) after::exec).after(this);
    }
     ...
     */
    default Executable8Throwing8<X1, X2, X3, X4, X5, X6, X7, X8, E1, E2, E3, E4, E5, E6, E7, E8> after(Executable8Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? super X6, ? super X7, ? super X8, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> before) {
        requireNonNull(before);
        return (x1, x2, x3, x4, x5, x6, x7, x8) -> { before.exec(x1, x2, x3, x4, x5, x6, x7, x8); exec(x1, x2, x3, x4, x5, x6, x7, x8); };
    }
     ...
     * @return an idle executable that does nothing
     */
    static <X1, X2, X3, X4, X5, X6, X7, X8, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Executable8Throwing8<X1, X2, X3, X4, X5, X6, X7, X8, E1, E2, E3, E4, E5, E6, E7, E8> idle() {
