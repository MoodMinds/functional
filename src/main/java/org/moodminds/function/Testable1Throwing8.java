 ...
 */
@FunctionalInterface
public interface Testable1Throwing8<X, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {
     ...
     */
    boolean test(X x) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     * @return a testable that represents the logical negation of this testable
     */
    default Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> not() {
        return not(this);
    }
     ...
     */
    default Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> or(Testable1Throwing8<? super X, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
        requireNonNull(testable);
        return x -> test(x) || testable.test(x);
    }
     ...
     * @throws NullPointerException if the given testable is {@code null}
     */
    default Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> and(Testable1Throwing8<? super X, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
        requireNonNull(testable);
        return x -> test(x) && testable.test(x);
    }
     ...
     * @throws NullPointerException if the given testable is {@code null}
     */
    default Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> nor(Testable1Throwing8<? super X, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
     ...
     * @return a positive testable that always returns true
     */
    static <X, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> anyway() {
        return x -> true;
    }
     ...
     * @return a negative testable that always returns false
     */
    static <X, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Testable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> noways() {
        return x -> false;
    }
}
