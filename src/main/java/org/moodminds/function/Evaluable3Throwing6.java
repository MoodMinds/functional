...
public interface Evaluable3Throwing6<X1, X2, X3, V, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception>
     ...
     * @return an operation that always returns its input argument 1
     */
    static <V1, V2, V3, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception> Evaluable3Throwing6<V1, V2, V3, V1, E1, E2, E3, E4, E5, E6> identity1() {
        return Evaluable3Throwing8.<V1, V2, V3, E1, E2, E3, E4, E5, E6, E6, E6>identity1()::eval;
    }
     ...
     * @return an operation that always returns its input argument 2
     */
    static <V1, V2, V3, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception> Evaluable3Throwing6<V1, V2, V3, V2, E1, E2, E3, E4, E5, E6> identity2() {
        return Evaluable3Throwing8.<V1, V2, V3, E1, E2, E3, E4, E5, E6, E6, E6>identity2()::eval;
    }
     ...
     * @return an operation that always returns its input argument 3
     */
    static <V1, V2, V3, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception> Evaluable3Throwing6<V1, V2, V3, V3, E1, E2, E3, E4, E5, E6> identity3() {
        return Evaluable3Throwing8.<V1, V2, V3, E1, E2, E3, E4, E5, E6, E6, E6>identity3()::eval;
    }
}
