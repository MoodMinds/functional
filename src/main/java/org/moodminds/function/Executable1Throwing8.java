 ...
 */
@FunctionalInterface
public interface Executable1Throwing8<X, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {

    /**
     * Execute the action logic by the specified input argument.
     *
     ...
     */
    void exec(X x) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     */
    default Executable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> then(Executable1Throwing8<? super X, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> after) {
        return ((Executable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8>) after::exec).after(this);
    }
     ...
     */
    default Executable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> after(Executable1Throwing8<? super X, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> before) {
        requireNonNull(before);
        return x -> { before.exec(x); exec(x); };
    }

    /**
     * Return an idle executable that does nothing.
     *
     * @param <X> the input type of the executable
     * @param <E1> the type of possible exception 1 that might be thrown
     * @param <E2> the type of possible exception 2 that might be thrown
     * @param <E3> the type of possible exception 3 that might be thrown
     * @param <E4> the type of possible exception 4 that might be thrown
     ...
     * @return an idle executable that does nothing
     */
    static <X, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Executable1Throwing8<X, E1, E2, E3, E4, E5, E6, E7, E8> idle() {
        return x -> {};
    }
}
