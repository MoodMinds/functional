...
public interface Evaluable2Throwing7<X1, X2, V, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception>
     ...
     * @return an operation that always returns its input argument 1
     */
    static <V1, V2, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception> Evaluable2Throwing7<V1, V2, V1, E1, E2, E3, E4, E5, E6, E7> identity1() {
        return Evaluable2Throwing8.<V1, V2, E1, E2, E3, E4, E5, E6, E7, E7>identity1()::eval;
    }
     ...
     * @return an operation that always returns its input argument 2
     */
    static <V1, V2, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception> Evaluable2Throwing7<V1, V2, V2, E1, E2, E3, E4, E5, E6, E7> identity2() {
        return Evaluable2Throwing8.<V1, V2, E1, E2, E3, E4, E5, E6, E7, E7>identity2()::eval;
    }
}
