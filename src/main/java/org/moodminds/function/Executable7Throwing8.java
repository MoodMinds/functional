 ...
 */
@FunctionalInterface
public interface Executable7Throwing8<X1, X2, X3, X4, X5, X6, X7, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {

    /**
     * Execute the action logic by the specified 7 input arguments.
     *
     ...
     */
    void exec(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5, X6 x6, X7 x7) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     */
    default Executable7Throwing8<X1, X2, X3, X4, X5, X6, X7, E1, E2, E3, E4, E5, E6, E7, E8> then(Executable7Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? super X6, ? super X7, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> after) {
        return ((Executable7Throwing8<X1, X2, X3, X4, X5, X6, X7, E1, E2, E3, E4, E5, E6, E7, E8>) after::exec).after(this);
    }
     ...
     */
    default Executable7Throwing8<X1, X2, X3, X4, X5, X6, X7, E1, E2, E3, E4, E5, E6, E7, E8> after(Executable7Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? super X6, ? super X7, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> before) {
        requireNonNull(before);
        return (x1, x2, x3, x4, x5, x6, x7) -> { before.exec(x1, x2, x3, x4, x5, x6, x7); exec(x1, x2, x3, x4, x5, x6, x7); };
    }
     ...
     * @return an idle executable that does nothing
     */
    static <X1, X2, X3, X4, X5, X6, X7, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Executable7Throwing8<X1, X2, X3, X4, X5, X6, X7, E1, E2, E3, E4, E5, E6, E7, E8> idle() {
