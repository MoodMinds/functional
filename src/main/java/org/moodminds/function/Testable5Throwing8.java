 ...
 */
@FunctionalInterface
public interface Testable5Throwing8<X1, X2, X3, X4, X5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {
     ...
     */
    boolean test(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     * @return a testable that represents the logical negation of this testable
     */
    default Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> not() {
        return not(this);
    }
     ...
     */
    default Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> or(Testable5Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
        requireNonNull(testable);
        return (x1, x2, x3, x4, x5) -> test(x1, x2, x3, x4, x5) || testable.test(x1, x2, x3, x4, x5);
    }
     ...
     * @throws NullPointerException if the given testable is {@code null}
     */
    default Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> and(Testable5Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
        requireNonNull(testable);
        return (x1, x2, x3, x4, x5) -> test(x1, x2, x3, x4, x5) && testable.test(x1, x2, x3, x4, x5);
    }
     ...
     * @throws NullPointerException if the given testable is {@code null}
     */
    default Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> nor(Testable5Throwing8<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> testable) {
     ...
     * @return a positive testable that always returns true
     */
    static <X1, X2, X3, X4, X5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> anyway() {
     ...
     * @return a negative testable that always returns false
     */
    static <X1, X2, X3, X4, X5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Testable5Throwing8<X1, X2, X3, X4, X5, E1, E2, E3, E4, E5, E6, E7, E8> noways() {
