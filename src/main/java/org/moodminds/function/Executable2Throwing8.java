 ...
 */
@FunctionalInterface
public interface Executable2Throwing8<X1, X2, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {

    /**
     * Execute the action logic by the specified 2 input arguments.
     *
     ...
     */
    void exec(X1 x1, X2 x2) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     */
    default Executable2Throwing8<X1, X2, E1, E2, E3, E4, E5, E6, E7, E8> then(Executable2Throwing8<? super X1, ? super X2, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> after) {
        return ((Executable2Throwing8<X1, X2, E1, E2, E3, E4, E5, E6, E7, E8>) after::exec).after(this);
    }
     ...
     */
    default Executable2Throwing8<X1, X2, E1, E2, E3, E4, E5, E6, E7, E8> after(Executable2Throwing8<? super X1, ? super X2, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> before) {
        requireNonNull(before);
        return (x1, x2) -> { before.exec(x1, x2); exec(x1, x2); };
    }
     ...
     * @return an idle executable that does nothing
     */
    static <X1, X2, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Executable2Throwing8<X1, X2, E1, E2, E3, E4, E5, E6, E7, E8> idle() {
        return (x1, x2) -> {};
    }
}
