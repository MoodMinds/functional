...
public interface Evaluable4Throwing3<X1, X2, X3, X4, V, E1 extends Exception, E2 extends Exception, E3 extends Exception>
     ...
     * @return an operation that always returns its input argument 1
     */
    static <V1, V2, V3, V4, E1 extends Exception, E2 extends Exception, E3 extends Exception> Evaluable4Throwing3<V1, V2, V3, V4, V1, E1, E2, E3> identity1() {
        return Evaluable4Throwing8.<V1, V2, V3, V4, E1, E2, E3, E3, E3, E3, E3, E3>identity1()::eval;
    }
     ...
     * @return an operation that always returns its input argument 2
     */
    static <V1, V2, V3, V4, E1 extends Exception, E2 extends Exception, E3 extends Exception> Evaluable4Throwing3<V1, V2, V3, V4, V2, E1, E2, E3> identity2() {
        return Evaluable4Throwing8.<V1, V2, V3, V4, E1, E2, E3, E3, E3, E3, E3, E3>identity2()::eval;
    }
     ...
     * @return an operation that always returns its input argument 3
     */
    static <V1, V2, V3, V4, E1 extends Exception, E2 extends Exception, E3 extends Exception> Evaluable4Throwing3<V1, V2, V3, V4, V3, E1, E2, E3> identity3() {
        return Evaluable4Throwing8.<V1, V2, V3, V4, E1, E2, E3, E3, E3, E3, E3, E3>identity3()::eval;
    }
     ...
     * @return an operation that always returns its input argument 4
     */
    static <V1, V2, V3, V4, E1 extends Exception, E2 extends Exception, E3 extends Exception> Evaluable4Throwing3<V1, V2, V3, V4, V4, E1, E2, E3> identity4() {
        return Evaluable4Throwing8.<V1, V2, V3, V4, E1, E2, E3, E3, E3, E3, E3, E3>identity4()::eval;
    }
}
