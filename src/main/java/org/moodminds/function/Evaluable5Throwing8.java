 ...
 */
@FunctionalInterface
public interface Evaluable5Throwing8<X1, X2, X3, X4, X5, V, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> {

    /**
     * Perform the operation by the specified 5 input arguments and return the result.
     *
     ...
     */
    V eval(X1 x1, X2 x2, X3 x3, X4 x4, X5 x5) throws E1, E2, E3, E4, E5, E6, E7, E8;
     ...
     */
    default <R> Evaluable5Throwing8<X1, X2, X3, X4, X5, R, E1, E2, E3, E4, E5, E6, E7, E8> then(Evaluable1Throwing8<? super V, ? extends R, ? extends E1, ? extends E2, ? extends E3, ? extends E4, ? extends E5, ? extends E6, ? extends E7, ? extends E8> after) {
     ...
     * @return an operation that always returns its input argument 1
     */
    static <V1, V2, V3, V4, V5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Evaluable5Throwing8<V1, V2, V3, V4, V5, V1, E1, E2, E3, E4, E5, E6, E7, E8> identity1() {
        return (v1, v2, v3, v4, v5) -> v1;
    }
     ...
     * @return an operation that always returns its input argument 2
     */
    static <V1, V2, V3, V4, V5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Evaluable5Throwing8<V1, V2, V3, V4, V5, V2, E1, E2, E3, E4, E5, E6, E7, E8> identity2() {
        return (v1, v2, v3, v4, v5) -> v2;
    }
     ...
     * @return an operation that always returns its input argument 3
     */
    static <V1, V2, V3, V4, V5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Evaluable5Throwing8<V1, V2, V3, V4, V5, V3, E1, E2, E3, E4, E5, E6, E7, E8> identity3() {
        return (v1, v2, v3, v4, v5) -> v3;
    }
     ...
     * @return an operation that always returns its input argument 4
     */
    static <V1, V2, V3, V4, V5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Evaluable5Throwing8<V1, V2, V3, V4, V5, V4, E1, E2, E3, E4, E5, E6, E7, E8> identity4() {
        return (v1, v2, v3, v4, v5) -> v4;
    }
     ...
     * @return an operation that always returns its input argument 5
     */
    static <V1, V2, V3, V4, V5, E1 extends Exception, E2 extends Exception, E3 extends Exception, E4 extends Exception, E5 extends Exception, E6 extends Exception, E7 extends Exception, E8 extends Exception> Evaluable5Throwing8<V1, V2, V3, V4, V5, V5, E1, E2, E3, E4, E5, E6, E7, E8> identity5() {
        return (v1, v2, v3, v4, v5) -> v5;
    }
}
